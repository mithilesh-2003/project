  ...
  return (
    <div className='main'>
      ...
      <div style={{marginTop:"30px"}}>
        ...
        <button style={{height:"40px",width:"300px",borderRadius:"30px",marginTop:"20px",border:"none",background:"#ffa637"}}>Login</button>
        <p>Alerady a member ?<Link to="/">Login here</Link></p>
      </div>
      </div>
